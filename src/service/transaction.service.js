...
export class TransactionService {
    ...
    async getMonthlyBalanceByUser(id) {
        try {
    ...
    async createTransactionService(user_id, date, amount, type, description, category_id, period) {
        try {
...
/* 
 async  getTransactionsByUser(id, limit = null) {
    try {
